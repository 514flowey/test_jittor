...
folder_name = "/home/flowey/2021haru/AI/DeepLearning/data/"
...
class TextRNN(jt.Module):
    ...
    def execute(self, inputs):
        ...
        hx=(jt.zeros((self._num_layers, batch_size, self._num_hiddens)), jt.zeros((self._num_layers, batch_size, self._num_hiddens)))
